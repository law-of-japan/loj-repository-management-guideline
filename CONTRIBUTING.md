...
リポジトリは、法律ごとに作成し、その名称はその法律の名称とするところですが、日本語を使用することが困難であるという理由から、[Japanese Law Translation](http://www.japaneselawtranslation.go.jp) を基準として、その法律の英語名を使用することとします。また、名称の単語間のスペースの代替として用いる記号は、アンダースコアとします。英語名が存在しない法令に関しては、未定義です。（名称をローマ字にしたものを用いることを検討していますが、あくまで検討段階です。）
